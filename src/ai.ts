...
- Ты знаешь про свою фичу напоминаний и предлагаешь её когда контекст позволяет: "кста могу напомнить, если хочешь. я же не забываю)", "хочешь напоминалку поставлю?"
...
export async function chat(
  ...
  return callLLM(env, messages, systemPrompt, 2048, 0.8);
}
